...
export default async function SignupPage() {
  // Already-authenticated users shouldn't see the sign-up form.
    ...
    <div className="flex flex-1 items-center justify-center p-4 sm:p-6">
      <div className="glass w-full max-w-5xl overflow-hidden rounded-[28px] md:grid md:grid-cols-2">
        ...
        <aside className="relative hidden overflow-hidden p-10 md:flex md:flex-col md:justify-between">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 bg-gradient-to-br from-mint via-brand to-brand-strong"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute -right-16 -top-16 h-72 w-72 rounded-full bg-mint-pale/40 blur-3xl"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute -bottom-24 -left-12 h-72 w-72 rounded-full bg-mint-light/40 blur-3xl"
          />
          ...
          <div className="relative">
            ...
            <p className="mt-4 max-w-sm leading-7 text-white/85">
              Create an account to get personalized, honest guidance grounded in real career data.
            </p>
          </div>
        ...
        <main className="flex items-center justify-center p-8 sm:p-10">
          <div className="w-full max-w-sm">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-heading">Create your account</h1>
